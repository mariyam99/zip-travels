...
const excluded = [
  'Jeep safari fee (Moon Plains)',
  'Entry fees to attractions',
  'Lunch & meals',
  'Boat ride at Gregory Lake (optional)',
  'Personal expenses',
]
...
const itinerary = [
  {
    icon: '🚙',
    time: '8:30 AM — Moon Plains (Sandathenna)',
    desc: 'Jeep safari to the summit of Moon Plains for breathtaking 360° panoramic views across the central highlands of Sri Lanka — rolling green hills as far as the eye can see.'
  },
  {
    icon: '💧',
    time: '10:00 AM — Bomburuella Waterfall',
    desc: "A 15–20 minute forest trek leads to Bomburuella — Sri Lanka's widest waterfall. Feel the cool mountain mist and take in the raw beauty of the highland jungle."
  },
  {
    icon: '🍛',
    time: '12:00 PM — Lunch in Nuwara Eliya',
    desc: 'Break for a traditional Sri Lankan rice & curry at a local restaurant, or enjoy a colonial-style tea house lunch in the heart of Nuwara Eliya.'
  },
  {
    icon: '🛕',
    time: '1:30 PM — Sitha Amman Kovil',
    desc: 'Visit this vibrant Hindu temple linked to the Ramayana legend, said to be the place where Sita was held captive. Modest dress required — sarongs available at the entrance.'
  },
  {
    icon: '🍓',
    time: '2:30 PM — Ambewela Strawberry Farm',
    desc: 'Stop at Sri Lanka\'s famous highland strawberry farm for fresh strawberry juice, ice cream, jams, wines and souvenirs. Best season: November – April.'
  },
  {
    icon: '🚤',
    time: '4:00 PM — Gregory Lake (Optional)',
    desc: 'A peaceful lakeside stroll around the iconic Gregory Lake in the cool highland air. Optional boat ride available for an extra charge.'
  },
  {
    icon: '🏨',
    time: '5:00–5:30 PM — Return to Hotel',
    desc: 'Comfortable drop-off at your Nuwara Eliya hotel.'
  },
]
  ...
  return (
    <main>
      ...
      <div style={{
        ...
        textAlign: 'center',
        overflow: 'hidden',
        backgroundImage: 'url(/images/bomburuella-hero.jpg)',
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          <p style={{ color: '#ff7600', fontWeight: '700', fontSize: '12px', letterSpacing: '3px', marginBottom: '14px', textShadow: '0 1px 4px rgba(0,0,0,0.6)' }}>
            FULL DAY TOURS FROM NUWARA ELIYA
          </p>
          <h1 style={{
            color: '#ffffff',
          ...
          <p style={{ color: '#e8eaf0', fontSize: '16px', maxWidth: '620px', margin: '0 auto 32px', lineHeight: '1.7', textShadow: '0 1px 6px rgba(0,0,0,0.6)' }}>
            Panoramic highland views, Sri Lanka's widest waterfall, a Ramayana-linked temple, fresh strawberries and a lakeside sunset — all in one cool-climate day from <strong style={{ color: '#ff7600' }}>Nuwara Eliya</strong>.
          </p>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            {[
              { icon: '⏱', label: '~9 Hours' },
              { icon: '🚙', label: 'Jeep Safari' },
              { icon: '💧', label: "Sri Lanka's Widest Falls" },
              { icon: '🍓', label: 'Strawberry Farm' },
            ].map(b => (
        ...
        <div>
          ...
          <div style={{ marginBottom: '48px' }}>
            ...
            <p style={{ color: '#555', fontSize: '15px', lineHeight: '1.9' }}>
              Experience the very best of Sri Lanka's cool highland region on this full day tour from Nuwara Eliya. From a <strong>360° jeep safari at Moon Plains</strong> to the thundering mist of <strong>Bomburuella Falls</strong>, the colourful Ramayana-linked <strong>Sitha Amman Kovil</strong>, the sweet delights of <strong>Ambewela Strawberry Farm</strong>, and a serene sunset at <strong>Gregory Lake</strong> — this tour packs an extraordinary variety of highland experiences into one unforgettable day.
            </p>
            <div style={{ display: 'flex', gap: '24px', marginTop: '20px', flexWrap: 'wrap' }}>
              {[
                { label: 'Pick-up', value: '8:00 AM' },
          ...
          <div style={{ marginBottom: '48px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                'Moon Plains jeep safari — 360° panoramic views across the central highlands',
                "Bomburuella Waterfall — Sri Lanka's widest waterfall via a scenic 15–20 min forest trek",
                'Sitha Amman Kovil — vibrant Ramayana-linked Hindu temple',
                'Ambewela Strawberry Farm — fresh juice, ice cream, jams & wines',
                'Gregory Lake — optional boat ride and peaceful lakeside sunset stroll',
                'Cool highland climate throughout the day',
            ...
            <div style={{ background: '#f8f9ff', borderRadius: '12px', padding: '24px', border: '1.5px solid #e4e8f0' }}>
              ...
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {[
                  ...
                  'Modest cover-up for temple',
                  'Camera',
                  'Cash for entry fees & extras',
                ].map((item, i) => (
          ...
          <div style={{ background: 'linear-gradient(135deg, #fff8f0, #fff3e0)', borderRadius: '12px', padding: '20px 24px', border: '1.5px solid #ffd599', display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
            ...
            <p style={{ color: '#7a4500', fontSize: '14px', lineHeight: '1.7' }}>
              <strong>Best season for strawberries:</strong> November – April. The Ambewela Farm is at peak harvest during these months — perfect for fresh strawberry picking and the freshest juice.
            </p>
          </div>
            ...
            {submitted ? (
              <div style={{ padding: '40px 28px', textAlign: 'center' }}>
                ...
                <p style={{ color: '#666', fontSize: '14px', lineHeight: '1.7' }}>
                  Thank you! Our team will confirm your Bomburuella & Moon Plains tour via WhatsApp or email within 24 hours.
                </p>
